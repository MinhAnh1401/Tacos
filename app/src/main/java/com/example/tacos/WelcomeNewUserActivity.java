...
public class WelcomeNewUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tvWelcome1 = findViewById(R.id.tv_welcome_1);
        textGradient(tvWelcome1);
        TextView tvWelcome2 = findViewById(R.id.tv_welcome_2);
        Button btnNext = findViewById(R.id.btn_next);

        animateTextView(tvWelcome1);
        animateTextView(tvWelcome2);

        btnNext.setOnClickListener(v -> {
            Intent intent = new Intent(WelcomeNewUserActivity.this, EnterCurrentBalanceActivity.class);
